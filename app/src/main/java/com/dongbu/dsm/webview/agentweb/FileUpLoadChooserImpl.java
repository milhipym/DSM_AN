...
import static com.dongbu.dsm.webview.agentweb.ActionActivity.KEY_ACTION;
import static com.dongbu.dsm.webview.agentweb.ActionActivity.KEY_FROM_INTENTION;
import static com.dongbu.dsm.webview.agentweb.ActionActivity.KEY_URI;
import static com.dongbu.dsm.webview.agentweb.ActionActivity.start;
...
public class FileUpLoadChooserImpl implements IFileUploadChooser {
    ...
    private void openFileChooserInternal() {
        ...
        if(mActivity != null) {
            ((BaseActivity)mActivity).showCameraGalleryPopupFromWebview(new CustomAlertDialogInterface.OnClickListener() {
                @Override
