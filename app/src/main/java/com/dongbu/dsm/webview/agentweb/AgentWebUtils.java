...
import static com.dongbu.dsm.webview.agentweb.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.dongbu.dsm.webview.agentweb.AgentWebConfig.FILE_CACHE_PATH;
...
//        /*如果无法直接打开，就跳出软件列表给用户选择 */
    ...
    static boolean isOverriedMethod(Object currentObject, String methodName, String method, Class... clazzs) {
        ...
        try {
            ...
            if(Config.DISPLAY_LOG) igonre.printStackTrace();
        }
    ...
    static void clearWebViewAllCache(Context context, WebView webView) {
        ...
        try {
            ...
            //ignorif(Config.DISPLAY_LOG) e.printStackTrace();
            if (AgentWebConfig.DEBUG)
                if(Config.DISPLAY_LOG) ignore.printStackTrace();
        }
    }

    static List<String> getDeniedPermissions(AppCompatActivity activity, String[] permissions) {
    ...
    static void clearCache(final Context context, final int numDays) {
     ...
     static String[] uriToPath(AppCompatActivity activity, Uri[] uris) {
        ...
        try {
            ...
            if (LogUtils.isDebug())
                if(Config.DISPLAY_LOG) throwable.printStackTrace();
        }
        return null;
    ...
    @TargetApi(19)
    static String getFileAbsolutePath(AppCompatActivity context, Uri fileUri) {
