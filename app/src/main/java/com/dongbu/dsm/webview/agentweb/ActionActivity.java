...
import static com.dongbu.dsm.webview.agentweb.ActionActivity.Action.ACTION_CAMERA;
import static com.dongbu.dsm.webview.agentweb.FileUpLoadChooserImpl.REQUEST_CODE;
...
public final class ActionActivity extends AppCompatActivity {
    ...
    static void start(AppCompatActivity activity, Action action) {
...
//            if (mFileDataListener != null)
    ...
    private void realOpenCamera() {
        ...
        try {
            ...
            if (mFile == null) {
                mFileDataListener.onFileDataResult(REQUEST_CODE, AppCompatActivity.RESULT_CANCELED, null);
                mFileDataListener = null;
                finish();
            }
