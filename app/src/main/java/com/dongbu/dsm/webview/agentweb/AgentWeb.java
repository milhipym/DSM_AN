...
public class AgentWeb {
    ...
    private boolean bUrlLoad = false;
    ...
    public static AgentBuilderFragment with(@NonNull Fragment fragment) {
        ...
        if ((mActivity = (AppCompatActivity) fragment.getActivity()) == null)
            throw new NullPointerException("activity can not null");
    ...
    private AgentWeb go(String url, boolean bUrlLoad) {
    ...
    public static class AgentBuilder {
        ...
        private AgentBuilder(AppCompatActivity activity) {
...
//                throw new IllegalStateException(" please call ready before go  to finish all webview settings");  //i want to do this , but i cannot;
        ...
        public AgentWeb go(@Nullable String url, @Nullable boolean bUrlLoad) {
            if (!isReady) {
//                throw new IllegalStateException(" please call ready before go  to finish all webview settings");  //i want to do this , but i cannot;
                ready();
            }
            return mAgentWeb.go(url, bUrlLoad);
        }
    ...
    public static final class CommonAgentBuilder {
        ...
        public CommonAgentBuilder setUrlLoad(@Nullable boolean bUrlLoad) {
            this.mAgentBuilder.bUrlLoad = bUrlLoad;
            return this;
        }
    ...
    public static final class AgentBuilderFragment {
        ...
        public AgentBuilderFragment(@NonNull AppCompatActivity activity, @NonNull Fragment fragment) {
            mActivity = activity;
            mFragment = fragment;
        }
