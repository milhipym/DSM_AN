package com.dongbu.dsm.webview;
...
public class AdvancedWebView extends WebView {
	...
	public void setListener(final AppCompatActivity activity, final Listener listener) {
		setListener(activity, listener, REQUEST_CODE_FILE_PICKER);
	}

	public void setListener(final AppCompatActivity activity, final Listener listener, final int requestCodeFilePicker) {
		if (activity != null) {
	...
	protected void setGeolocationDatabasePath() {
		...
		if (mFragment != null && mFragment.get() != null && Build.VERSION.SDK_INT >= 11 && mFragment.get().getActivity() != null) {
			activity = (AppCompatActivity) mFragment.get().getActivity();
		}
	...
	protected void init(Context context) {
		...
		if (context instanceof AppCompatActivity) {
			mActivity = new WeakReference<AppCompatActivity>((AppCompatActivity) context);
		}
...
//			}
	...
	public static class Browsers {
		 ...
		 */
		public static void openUrl(final AppCompatActivity context, final String url) {
		 ...
		 */
		public static void openUrl(final AppCompatActivity context, final String url, final boolean withoutTransition) {
